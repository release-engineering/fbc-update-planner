...
// newPackage translates a PLCC product into FBC types, returning errors for invalid data
// (malformed versions or unparseable timestamps). [Translate] then runs a configurable
// filter pipeline that cleans the output (e.g., dropping incomplete phases).
//
